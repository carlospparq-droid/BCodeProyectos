document.addEventListener('DOMContentLoaded', function () {
    ...
    const textosPersuasion = [
        "Mi vida no tiene sentido sin tu perdón",
        "Lamento profundamente haberte herido",
        "Tu sonrisa es lo que más extraño cada día",
        "No quiero un futuro sin tu perdón",
        "Mi corazón se arrepiente por lo que hice",
        "¡Si me perdonas, prometo cuidar tu amor como nunca! Te extraño"
    ];
    ...
    function mostrarMensajePersuasion() {
        mensajePersuasion.textContent = [
            "¿Estás segura de no perdonarme? ¡Piénsalo bien!",
            "Por favor, dame otra oportunidad",
            "Mi corazón se rompe al saber que te fallé",
            "Eres la mujer que más he amado",
            "¡No me apartes de tu vida! Te extraño"
        ][contadorNoClicks - 1];
